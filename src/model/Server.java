...
public class Server {
  ...
  public Set<String> getPlayers() {
	...
	public GamePhase switchPhase () {
	  switch (phase) {
        case CONNECTION: this.phase = GamePhase.WRITE_OF_STORY; break;
        case WRITE_OF_STORY: this.phase = GamePhase.CHOOSE_CARD; break;
        case CHOOSE_CARD: this.phase = GamePhase.VOTING; break;
        case VOTING: this.phase = GamePhase.WRITE_OF_STORY;
                     this.chosenCards.clear();
                     this.votedCards.clear(); break;
      }
      this.chosen = 0;
